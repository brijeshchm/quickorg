            ...
            <section id="data-security" class="scroll-reveal glass-card rounded-2xl p-8 mb-8">
                ...
                <div class="text-sm leading-relaxed space-y-3 section-body">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            <p>While we deploy industry-standard safeguards, no method of transmission over the internet is 100% secure. Users are responsible for keeping login credentials confidential and notifying us immediately at <strong>security@quickdials.org</strong> in case of suspected unauthorized access.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="user-rights" class="scroll-reveal glass-card rounded-2xl p-8 mb-8">
                ...
                <div class="text-sm leading-relaxed space-y-3 section-body">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            <p>To exercise any of the above rights, submit a written request to <strong>privacy@quickdials.org</strong> with the subject line "Data Principal Rights Request". Provide your registered email/mobile, the right you wish to exercise, and any supporting documentation. We will verify your identity and respond within a reasonable period, typically within thirty (30) days.</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            ...
                            <ul class="list-none mt-3 space-y-1">
                                ...
                                <li><strong>Email:</strong> info@quickdials.org</li>
                                <li><strong>Phone:</strong> +91-75-9543-9543</li>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="mt-3 flex flex-wrap gap-2">
                                    <a href="mailto:privacy@quickdials.org" class="btn-purple inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-md">
                                        Privacy Requests
                                    </a>
                                    <a href="mailto:grievance@quickdials.org" class="btn-purple inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-md">
                                        Grievance Officer
                                    </a>
                                    <a href="mailto:security@quickdials.org" class="btn-purple inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-md">
                                        Report a Breach
                                    </a>
                                </div>
                            </div>
