          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="plan-demo-btns" style="margin-top: 40px"> <a href="https://www.quickdials.org/" target="_black" class="header-plans-btn" style="color:#fff !important"> <i class="fa fa-forward"></i> See certified institutions<i class="fa fa-backward"></i></a><div class="clearfix"></div></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="panel-group" id="accordion">
              ...
              <div class="panel panel-default">
                ...
                <div id="check2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <p>
                      Connect from our expert customer support at help@quickdials.org 
                    </p>
                  </div>
                </div>
              </div>
