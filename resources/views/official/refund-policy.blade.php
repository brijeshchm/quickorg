        ...
        <div class="flex-1 min-w-0">
            ...
            <section id="introduction" class="scroll-reveal glass-card rounded-2xl p-8 mb-8">
                ...
                <div class="text-sm leading-relaxed space-y-3 section-body">
                    <p>This Refund and Cancellation Policy ("<strong>Policy</strong>") is issued by <strong>Quickdials Internet Pvt. Ltd.</strong> ("QuickDials", "Company", "we", "us", or "our") and governs all refunds and cancellations relating to paid services purchased through <strong>www.quickdials.org</strong> or our mobile applications.</p>
            ...
            <section id="process" class="scroll-reveal glass-card rounded-2xl p-8 mb-8">
                ...
                <div class="text-sm leading-relaxed space-y-3 section-body">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            <p>Submit a written refund request via email to <strong>support@quickdials.org</strong> within seven (7) days of the transaction. Include all required documentation as specified in the Refund Eligibility section.</p>
                        </div>
                    </div>
            ...
            <section id="cancellation" class="scroll-reveal glass-card rounded-2xl p-8 mb-8">
                ...
                <div class="text-sm leading-relaxed space-y-3 section-body">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            <p>Customers may cancel an active subscription at any time through their account dashboard or by writing to <strong>support@quickdials.org</strong>. Cancellation will take effect at the end of the current billing cycle. The subscription will remain active and accessible until the expiry of the paid period; no pro-rata refund shall be provided for the unused portion unless eligibility under the Refund Policy is met.</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="pl-4 border-l-2 subsection-border">
                            ...
                            <ul class="list-none mt-3 space-y-1">
                                ...
                                <li><strong>Email:</strong> grievance@quickdials.org</li>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="mt-3 flex flex-wrap gap-2">
                                    <a href="mailto:support@quickdials.org" class="btn-purple inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-md">
                                        Refund Support
                                    </a>
