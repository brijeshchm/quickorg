    ...
    <section class="relative z-10 px-6 pt-10 pb-14 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-14">
            ...
            $contactInfo = [
                ...
                [
                    'label'     => 'Email',
                    'value'     => 'info@quickdials.org',
                    'sub'       => 'We reply within 24 hours',
                    'href'      => 'mailto:info@quickdials.org',
                    'iconBg'    => 'bg-blue-50',
                ...
                [
                    'label'     => 'Support',
                    'value'     => 'support@quickdials.org',
                    'sub'       => '24/7 live chat available',
                    'href'      => 'mailto:support@quickdials.org',
                        ...
                        <div class="relative z-10 flex flex-col sm:flex-row gap-6 sm:items-start justify-between">
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <a href="mailto:info@quickdials.org" class="flex items-center gap-2 text-sm font-medium text-violet-600 hover:opacity-70 transition-opacity">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                        </svg>
                                        info@quickdials.org
