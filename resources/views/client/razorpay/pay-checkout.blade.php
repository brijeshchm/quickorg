...
<form id="razorpay-frm-payment">
                        <div >
                            ...
                            <input type="hidden" name="surl" id="surl" value="https://www.quickdials.org/payment-done">
                            <input type="hidden" name="furl" id="furl" value="https://www.quickdials.org/failed"> 
...
jQuery(document).ready(function ($) {
    ...
    $('#razor-pay-now').on('click', function (e) {
        ...
        var razorpay_options = {
            ...
            image: 'https://www.quickdials.org/client/images/small-logo.jpg',
            netbanking: true,
