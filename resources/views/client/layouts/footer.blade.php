...
<section class="bg-gray-50 border-t border-gray-100 py-10" aria-label="Popular services on QuickDials">
    <div class="container mx-auto px-4">
        ...
        {{-- ─── Main Footer Grid ─── --}}
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-10 pl-3">
            ...
            <div>
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="mailto:support@quickdials.org" class="text-violet-600 hover:text-violet-800 hover:underline transition-colors ml-1">support@quickdials.org</a>
                    </p>
                    <p class="text-sm text-gray-600">
