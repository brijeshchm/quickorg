  ...
  <table class="email-wrap" border="0" cellpadding="0" cellspacing="0" width="640"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            ...
            <td class="hide-mob" width="50%" valign="middle" align="right"
              ...
              📞 +91-75-5943-5943 &nbsp;|&nbsp; info@quickdials.org<br>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#78350F;line-height:1.6;">
                    ...
                    <a href="https://www.quickdials.org" target="_blank" style="color:#005DFF;font-weight:600;text-decoration:none;">quickdials.org</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#78350F;line-height:1.6;">
                ...
                <tr>
                  <td style="padding:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#78350F;line-height:1.6;">
                    ...
                    <a href="mailto:help@quickdials.org" style="color:#005DFF;font-weight:600;text-decoration:none;">help@quickdials.org</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#78350F;">
                    →
                    <a href="https://www.quickdials.org/official/privacy-policy" target="_blank"
    ...
    <tr>
      <td style="padding:20px 40px 28px 40px;font-family:Arial,Helvetica,sans-serif;font-size:13.5px;color:#374151;line-height:1.8;">
        ...
        <a href="https://www.quickdials.org" target="_blank"
           style="color:#005DFF;text-decoration:none;font-size:12px;">www.quickdials.org</a>
      </td>
    </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%"
          ...
          <tr>
            <td style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#6B7280;line-height:1.6;">
              ...
              Contact us at <a href="mailto:help@quickdials.org" style="color:#005DFF;">help@quickdials.org</a> for any queries.
            </td>
          </tr>
        </table>
      </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            ...
            <td valign="top" align="right"
              ...
              <a href="https://quickdials.org/official/privacy-policy" target="_blank"
