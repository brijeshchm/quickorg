          ...
          <tr>
            <td width="55%" valign="middle">
              <a href="https://www.quickdials.org" target="_blank" style="text-decoration:none;">
                <img src="https://quickdials.org/client/images/quick-large-logo.png"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background:linear-gradient(135deg,#FB641B,#FF8C42);border-radius:8px;">
                          <a href="https://www.quickdials.org/pricing" target="_blank"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            ...
            <td valign="top" align="right"
              ...
              <a href="https://quickdials.org/pricing" target="_blank"
                 style="color:rgba(255,255,255,.65);text-decoration:none;display:block;margin-bottom:5px;">
                Upgrade Plan
              </a>
