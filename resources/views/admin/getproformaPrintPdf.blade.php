  ...
  <div class="inv-header">
    <div class="header-inner">
      ...
      <div class="header-left">
        <img src="https://www.quickdials.org/client/images/small-logo.png" alt="Quick Dials" class="logo">
        <div class="company-name">Quick Dials Pvt. Ltd.</div>
        <div class="company-info">
          G-13, Third Floor, Sector-3 Noida, U.P. India<br>
          📞 +91-75-9543-9543 &nbsp;|&nbsp;
          ✉ <a href="mailto:info@quickdials.org">info@quickdials.org</a> &nbsp;|&nbsp;
          🌐 <a href="https://www.quickdials.org" target="_blank">www.quickdials.org</a>
        </div>
      </div>
    ...
    <div class="footer-inner">
      <div class="footer-office">
        ...
        <span style="opacity:.5;font-size:10.5px;">
          For support: <a href="https://www.quickdials.org/contact-us" target="_blank" style="color:rgba(255,255,255,.7);text-decoration:none;">help@quickdials.org</a>
          &nbsp;|&nbsp; Timings: 24/7
        </span>
      </div>
