...
<div class="page">
  ...
  <div class="inv-header">
    <div class="header-top">
      <div class="brand-block">
        <img src="https://www.quickdials.org/client/images/small-logo.png" alt="Quick Dials">
        <h1>Quick Dials Internet Pvt. Ltd.</h1>
        <p>
          Pillar No.33, NH-19, Faridabad, Haryana<br>
          📞 +91-75-5943-5943 &nbsp;|&nbsp; ✉ info@quickdials.org &nbsp;|&nbsp; 🌐 www.quickdials.org
        </p>
      </div>
  ...
  <div class="inv-body">
    ...
    <div class="notes-box">
      ...
      <ul>
        <li>You can check your balance value and pending lead details after logging into quickdials.org.</li>
        ...
        <li>For queries, email us at <a href="mailto:help@quickdials.org" style="color:#92400E;font-weight:600;">help@quickdials.org</a></li>
  ...
  <div class="inv-footer">
    <div class="footer-left">
      <a href="https://www.quickdials.org/privacy-policy" target="_blank" class="tc-link">
        Terms &amp; Conditions →
      </a>
